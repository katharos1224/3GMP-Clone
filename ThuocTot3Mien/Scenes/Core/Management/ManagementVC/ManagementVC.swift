...
final class ManagementVC: BaseViewController {
    ...
    let menuItems = [
        ...
        MenuItem(title: "Quản lý gian hàng", imageName: "list.bullet.clipboard.fill"),
        ...
        MenuItem(title: "Điều khoản sử dụng", imageName: "doc.text.fill"),
        MenuItem(title: "Chính sách bảo mật", imageName: "checkmark.shield.fill"),
